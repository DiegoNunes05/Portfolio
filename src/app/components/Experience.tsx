...
export function Experience() {
  return (
    <section id="experience" className="w-full py-12 bg-gray-100">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div className="space-y-8">
          ...
          <SlideUpAnimation delay={100}>
            <Card className="card-type experience-card">
              <CardHeader>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div className="flex gap-4 items-center">
                    <div>
                      <Image
                        src="/experience-images/billor-logo.jpeg"
                        alt={"Billor"}
                        width={40}
                        height={40}
                      />
                    ...
                    <div>
                      ...
                      <CardDescription className="mt-1">
                        ...
                        <span className="text-gray-500">
                          {" "}
                          • Full-time • Joinville, Santa Catarina
                        </span>
                      </CardDescription>
                    </div>
                  </div>
          ...
          <SlideUpAnimation delay={200}>
            <Card className="card-type experience-card">
                  ...
                  <div className="flex gap-4 items-center">
                    ...
                    <div>
                      ...
                      <CardDescription className="mt-1">
                        ...
                        <span className="text-gray-500">
                          {" "}
                          • Full-time • New Jersey, United States
                        </span>
                      </CardDescription>
                    </div>
                  </div>
              ...
              <CardContent>
                <p className="mb-4 text-gray-700">
                  Built and maintained key application features using React,
                  Next.js, TypeScript, and Shadcn UI. My work included the
